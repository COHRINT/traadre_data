...
class SimulationWindow(QWidget):
	...
	def populateInterface(self):
		...
		self.pushLayout.addWidget(self.sq_label,3,3,1,4)
		self.sq_label.setStyleSheet("background-color: white; border: 4px inset grey;")
		self.sq_label.setFont(QtGui.QFont('Lato', 15))

		self.oa_label = QLabel()
		self.oa = None
		self.oa_label.setText('Outcome Assessment: ' + str(self.oa))
		self.pushLayout.addWidget(self.oa_label,6,3,1,4)
		self.oa_label.setStyleSheet("background-color: white; border: 4px inset grey;")
		self.oa_label.setFont(QtGui.QFont('Lato', 15))
